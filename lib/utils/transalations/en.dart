const Map<String, String> en = {
  ...
  'login.screen.password_required.error': 'Please enter a valid password',
  ...
  'identification.screen.email.title': 'Email verified',
  'identification.screen.deposit': 'Deposit',
  'identification.screen.withdraw': 'Withdraw',
  'identification.screen.trade': 'Trade',
  'identification.screen.enabled': 'Enabled',
  'identification.screen.phone.unverified.title': 'Phone verification',
  'identification.screen.phone.title': 'Phone verified',
  'identification.screen.identity.unverified.title': 'Identity verification',
  'identification.screen.identity.title': 'Identity verified',
  'identification.screen.pending': 'Pending',
  'identification.screen.rejected': 'Rejected',
  ...
  'home.screen.link.card.trade': 'Trade',
  'home.screen.p2p_buy_sell_tabs.losers': 'Losers',
  'home.screen.p2p_buy_sell_tabs.gainers': 'Gainers',
  'home.screen.link.card.deposit_withdraw_history': 'Deposit/Withdraw History',
  'home.screen.link.card.savings': 'Savings',
  'home.screen.link.card.history': 'History',
  'home.screen.link.card.more': 'More',
  'home.screen.link.card.visa_master_card': 'Visa, MasterCard',
  'home.screen.link.card.credit_debit_card': 'Credit/Debit Card',
  'home.screen.link.card.paypal_revoult': 'PayPal, Revoult',
  'home.screen.link.card.bank_Transfer': 'BankTransfer,',
  'home.screen.link.card.p2p_trading': 'P2P Trading',
  ...
  'market_detail.p2p_buy_sell_tabs.line': 'Line',
  'market_detail.p2p_buy_sell_tabs.depth': 'Depth',
  'market_detail.order_book': 'Order Book',
  'market_detail.button.buy': 'Buy',
  'market_detail.button.sell': 'Sell',

  //App Trading Screen
  'trading.screen.p2p_buy_sell_tabs.limit': 'Limit',
  'trading.screen.p2p_buy_sell_tabs.market': 'Market',
  ...
  'wallet_detail.screen.p2p_buy_sell_tabs.deposit_history': 'Deposit History',
  'wallet_detail.screen.p2p_buy_sell_tabs.withdraw_history': 'Withdraw History',
  ...
  'history.screen.p2p_buy_sell_tabs.deposit_history': 'Deposit History',
  'history.screen.p2p_buy_sell_tabs.withdraw_history': 'Withdraw History',
  'history.screen.p2p_buy_sell_tabs.trade_history': 'Trade History',
  'history.screen.side': 'Side',
  'history.screen.price': 'Price',
  'history.screen.amount': 'Amount',
  ...
  'authz.invalid_session': 'Unauthorized session',
