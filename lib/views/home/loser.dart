        ...
        Obx(() {
          if (marketController.isLoading.value)
            ...
            return _marketsLoaded(
                context, marketController.negativeMarketsList);
        }),
      ],
    );
  }
    ...
    return formatedMarketList.isEmpty
        ...
        : Flexible(
            child: ListView.builder(
              ...
              itemBuilder: (ctx, i) {
                return listPriceloser(formatedMarketList[i], ctx);
              },
            ),
          );
  }

  Widget listPriceloser(FormatedMarket formatedMarket, BuildContext ctx) {
    return Padding(
