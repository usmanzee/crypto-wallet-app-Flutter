...
class LockedTab extends StatelessWidget {
          ...
          Flexible(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
               /* return data[index].type == 'locked'
                    ? _container(imageUrl: '',index: index,name: 'name',rate: '23.3')
                    : Container();*/
  ...
  Widget _container({@required String imageUrl,@required int index,@required String name,@required String rate}){
    return Obx(() => Card(
      child: Padding(
                  ...
                  children: [
                    Expanded(
                      child: _duration(
                        duration: 7,
                        index: index,
                        value: _savingsController.values[index],
                      ),
                    ),
                  ],
                )
  ...
  Widget _duration(
    ...
    return GestureDetector(
      onTap: () {
        _savingsController.values[index] = duration;
      },
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 16),
        decoration: BoxDecoration(
          color: _savingsController.values[index] == duration
