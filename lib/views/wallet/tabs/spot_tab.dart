            ...
            slivers: [
              SliverList(
                delegate: SliverChildBuilderDelegate(
                    ...
                    return headerWidget(firstValue: estimatedValueSecondary,secondValue: estimatedValue.toString());
                  },
                  childCount: 1,
                ),
              ),
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                      (context, index) {
                    return walletList(walletController.walletsList[index]);
                  },
                  childCount: walletController.walletsList.length,
                ),
              ),
            ],
          ),
