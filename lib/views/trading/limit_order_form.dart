...
class LimitOrderForm extends StatelessWidget {
  ...
  KeyboardActionsConfig _limitBuyOrderbuildConfig(BuildContext context) {
    return KeyboardActionsConfig(
      keyboardActionsPlatform: KeyboardActionsPlatform.IOS,
      nextFocus: true,
      actions: [
        KeyboardActionsItem(
          focusNode: tradingController.limitBuyPriceFocusNode,
        ),
        KeyboardActionsItem(
  ...
  KeyboardActionsConfig _limitSellOrderbuildConfig(BuildContext context) {
    return KeyboardActionsConfig(
      keyboardActionsPlatform: KeyboardActionsPlatform.IOS,
      nextFocus: true,
      actions: [
        KeyboardActionsItem(
          focusNode: tradingController.limitSellPriceFocusNode,
        ),
        KeyboardActionsItem(
    ...
    return Row(children: [
      Expanded(
        ...
        child: Form(
          ...
          child: KeyboardActions(
            config: _limitBuyOrderbuildConfig(context),
            child: Column(
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible(
                          child: TextFormField(
                            focusNode:
                                tradingController.limitBuyAmountFocusNode,
                            controller: tradingController
                    ...
                    child: Container(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          ...
                          if (tradingController.limitOrderBuyPriceTextController.text != '' &&
                              tradingController
      ...
      Form(
        ...
        child: Expanded(
          flex: 50,
          child: KeyboardActions(
            config: _limitSellOrderbuildConfig(context),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: TextFormField(
                            ...
                            textInputAction: TextInputAction.next,
                            focusNode:
                                tradingController.limitSellPriceFocusNode,
                            onEditingComplete: () => tradingController
                ...
                Padding(
                    ...
                    child: Obx(() {
                      return Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: tradingController
                            .limitSellFormPercentageOptions
                            .map((option) {
                          return InkWell(
                            onTap: () {
                              tradingController.percentageOptionClick(
                    ...
                    child: Row(
                      children: [
                        Flexible(
                          child: TextFormField(
                            focusNode:
                                tradingController.limitSellTotalFocusNode,
                            controller: tradingController
                    ...
                    child: Container(
                      ...
                      child: MaterialButton(
                        ...
                        child: Center(
                            child: Text(
                          formatedMarket.baseUnit != null
                              ? "trading.screen.tab.limit.sell.button"
                                  .trParams({
                                  'currency':
                                      formatedMarket.baseUnit.toUpperCase()
                                })
