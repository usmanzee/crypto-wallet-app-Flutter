...
class MarketOrderForm extends StatelessWidget {
  ...
  KeyboardActionsConfig _marketBuyOrderbuildConfig(BuildContext context) {
    return KeyboardActionsConfig(
      keyboardActionsPlatform: KeyboardActionsPlatform.IOS,
      nextFocus: true,
      actions: [
        KeyboardActionsItem(
          focusNode: tradingController.marketBuyAmountFocusNode,
        ),
        KeyboardActionsItem(
  ...
  KeyboardActionsConfig _marketSellOrderbuildConfig(BuildContext context) {
    return KeyboardActionsConfig(
      keyboardActionsPlatform: KeyboardActionsPlatform.IOS,
      nextFocus: true,
      actions: [
        KeyboardActionsItem(
          focusNode: tradingController.marketSellAmountFocusNode,
        ),
        KeyboardActionsItem(
      ...
      children: [
        Expanded(
          ...
          child: Form(
            ...
            child: KeyboardActions(
              config: _marketBuyOrderbuildConfig(context),
              child: Column(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: TextFormField(
                              ...
                              onChanged: tradingController
                                  .onMarketOrderBuyAmountChange,
                              ...
                              focusNode:
                                  tradingController.marketBuyAmountFocusNode,
                  ...
                  Padding(
                      ...
                      child: Obx(() {
                        return Row(
                          ...
                          children: tradingController
                              .marketBuyFormPercentageOptions
                              .map((option) {
                            return InkWell(
                              onTap: () {
                      ...
                      child: Row(
                        children: [
                          Flexible(
                            child: TextFormField(
                              focusNode:
                                  tradingController.marketBuyTotalFocusNode,
                              controller: tradingController
                              ...
                              decoration: new InputDecoration(
                                  ...
                                  hintText: formatedMarket.quoteUnit != null
                                      ? "trading.screen.tab.market.buy.field.total"
                                          .trParams({
                                          'currency': formatedMarket.quoteUnit
                                              .toUpperCase()
                                        })
                                      : '',
                                  hintStyle: TextStyle(fontSize: 14)),
                        ...
                        child: MaterialButton(
                          ...
                          child: Center(
                            ...
                            formatedMarket.baseUnit != null
                                ? "trading.screen.tab.market.buy.button"
                                    .trParams({
                                    'currency':
        ...
        Form(
          ...
          child: Expanded(
            flex: 50,
            child: KeyboardActions(
              config: _marketSellOrderbuildConfig(context),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Padding(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: TextFormField(
                              ...
                              textInputAction: TextInputAction.next,
                              focusNode:
                                  tradingController.marketSellAmountFocusNode,
                              onEditingComplete: () => tradingController
                  ...
                  Padding(
                    ...
                    child: Obx(() {
                      return Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: tradingController
                            .marketSellFormPercentageOptions
                            .map((option) {
                          return InkWell(
                            onTap: () {
                              tradingController.percentageOptionClick(
                      ...
                      child: Row(
                        children: [
                          Flexible(
                            child: TextFormField(
                              focusNode:
                                  tradingController.marketSellTotalFocusNode,
                              controller: tradingController
                                  .marketOrderSellTotalTextController,
                              onChanged: tradingController
                                  .onMarketOrderSellTotalChange,
                              cursorColor: Theme.of(context)
                                  .textSelectionTheme
                                  .selectionColor,
                              keyboardType: TextInputType.number,
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: Row(
                              children: [
                                Text(
                                  tradingController.marketTradingFee.taker !=
                                          null
                                      ? (double.parse(tradingController
                                                      .marketTradingFee.taker) *
                                                  100)
                      ...
                      child: Container(
                        ...
                        child: MaterialButton(
                          ...
                          child: Center(
                            child: Text(
                              formatedMarket.baseUnit != null
                                  ? "trading.screen.tab.market.sell.button"
                                      .trParams(
                                      {
                                        'currency': formatedMarket.baseUnit
                                            .toUpperCase()
                                      },
                                    )
                                  : '',
